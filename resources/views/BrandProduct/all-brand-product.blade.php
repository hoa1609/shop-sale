        ...
        <div class="row wrapper1 border-bottom white-bg page-heading">  
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Liệt kê hiệu sản phẩm</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                ...
                <tbody>
                    ...
                    @foreach ($all_brand_product as $key =>$brand_pro )
                        <tr>
                                ...
                                <span class="text-ellipsis">
                                        ...
                                        <?php
                                            if ($brand_pro ->brand_status == 0){
                                                ?>
                                                <a href="{{ route('unactive-brand-product',$brand_pro ->brand_id)}}"> 
                                                    <input type="checkbox" class="js-switch" checked /> 
                                                </a>
                                                <?php
                                            }else {
                                                ?>
                                                <a href="{{ route('active-brand-product',$brand_pro ->brand_id)}}"> 
                            ...
                            <td  class="text-center">
                                    <a href="{{route('edit-brand-product-form', $brand_pro ->brand_id )}}" class="btn btn-success" style="zoom: .65"> 
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="{{ route('delete-brand-product', $brand_pro->brand_id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
